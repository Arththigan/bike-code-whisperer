...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "OBD-Decoder · Bike DTC Code Lookup" },
      { property: "og:description", content: "Workshop-ready bike diagnostic code lookup with symptoms and action plan." },
